...
{
    /// <summary>
    /// DTO đại diện cho dữ liệu Excel của Làn kiểm soát (Lane)
    /// </summary>
    ...
    /// <summary>
    /// Cấu hình Fluent Profile cho Làn kiểm soát (ADR 0023)
    /// </summary>
    public class LaneExcelProfile : ExcelProfile<LaneExcelDto>
    {
        public LaneExcelProfile()
        {
            ...
            Map(x => x.GateCode).ColumnName("Mã cổng").Order(3).WithComment("Mã hoặc tên cổng trực thuộc");
