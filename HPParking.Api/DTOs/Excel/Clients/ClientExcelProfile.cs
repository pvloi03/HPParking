...
{
    /// <summary>
    /// Cấu hình Fluent Profile cho Mẫu / Nhập liệu chủ xe (Dùng Mã nghiệp vụ làm khóa ngoại tham chiếu)
    /// </summary>
    ...
    /// <summary>
    /// Cấu hình Fluent Profile cho Xuất dữ liệu chủ xe (Đầy đủ tất cả thông tin, khóa liên kết đổi thành Tên)
    /// </summary>
